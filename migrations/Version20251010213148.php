 ...
 */
final class Version20251010213148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE obligation ADD remaining_amount NUMERIC(10, 2) NOT NULL, ADD file_url VARCHAR(255) DEFAULT NULL, CHANGE adress adress VARCHAR(255) DEFAULT NULL, CHANGE conditon_type conditon_type VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE obligation DROP remaining_amount, DROP file_url, CHANGE adress adress LONGTEXT DEFAULT NULL, CHANGE conditon_type conditon_type VARCHAR(255) NOT NULL');
    }
}
